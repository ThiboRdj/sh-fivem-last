...
```
bash <(wget -O - 'https://raw.githubusercontent.com/ThiboRdj/sh-fivem-last/master/sh-fivem.sh')
```

# Lien de l'installation BETA :
```
bash <(wget -O - 'https://raw.githubusercontent.com/ThiboRdj/sh-fivem-last/master/sh-beta.sh')
```
